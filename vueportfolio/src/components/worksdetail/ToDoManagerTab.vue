<template>
    <div>
        ...
        <p>
            ...
            以前のものは、「リロードしたら消えてしまう」「チェックボックスをクリックす<br>
            ると消える仕組みだが、気になる部分があった」「チェックボックスだとあまりに<br>
            も単純すぎる」と感じ、これらを改善するように努めた。<br>
            まず、リロードしたら消える点に関しては、Vuex・Vuex PersistedStateを利用する<br>
            ことで、解決しました。チェックボックス の部分は、完了したことを明示する方<br>
