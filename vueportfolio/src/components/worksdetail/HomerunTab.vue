<template>
    <div>
        ...
        <p>
            ...
            その時、カウンセリングの先生に教えて頂いたことが、「ほめること」の大切さでした。<br>
            うつ病の原因の1つとして、自己肯定感の低さ・自信のなさが挙げられます。これを解決<br>
            する方法が、毎日、1日の終わりにその日の自分をほめること、労うことであるそうです。<br>
            でも、なかなか自分ではほめることができませんでした。<br>
            そこで、第3者的立場から毎日、自分をほめることができれば、どんなに自己肯定感の低<br>
            下してしまった人でも自分をほめる機会を得ることができると考え、制作しました。
        </p>
        <h4>使用言語・技術等</h4>
