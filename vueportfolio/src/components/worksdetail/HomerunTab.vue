<template>
    <div>
        ...
        <h4>制作のきっかけ</h4>
        <p>
            私は、大学4年生の時に、うつ病と診断を受けた。現在は、治っている。<br>
            その時、カウンセリングの先生に教えて頂いたことが、「ほめること」の大切さだ。<br>
            うつ病の原因の1つとして、自己肯定感の低さ・自信のなさが挙げられる。<br>
            これを解決する方法が、毎日、1日の終わりにその日の自分をほめること、労うことであるそうだ。<br>
            でも、なかなか自分ではほめることができなかった。<br>
            そこで、第3者的立場から毎日、自分をほめることができれば、どんなに自己肯定感の低下してしまった人でも<br>
